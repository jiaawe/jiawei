...
export const experiences: Experience[] = [
  {
    ...
    bullets: [
      "Developed real-time address clustering strategies to flag thousands of risky transactions per day",
      "Built real-time address embedding & recall pipelines, processing addresses with >1000 QPS in <110ms"
    ]
  },
  {
    id: 2,
    ...
    bullets: [
      "Developed a Retrieval Augmented Generation pipeline to retrieve thousands of videos with >95% accuracy within 3s",
      "Sped up inference speeds of generative models by >30% via open-source frameworks",
      "Researched on dataset distillation methods to reduce training time and costs by >50%"
    ]
  },
  {
    id: 3,
    ...
    bullets: [
      "Researched and developed multimodal machine learning models for video analytics applications",
      "Built processing and training pipelines on AWS to automate data ingestion, model monitoring and retraining"
    ]
  },
  {
    id: 4,
    ...
    bullets: [
      "Spearheaded an automated quarterly survey sentiment analysis project, saving over 70% manual hours",
      "Pioneered a machine learning project to predict potential voluntary attrition and analysed their factors leading to it"
    ]
  }
];